...
Und **figcaption**: used to embed images and provide a caption for them.
...
U used to provide different images for different display conditions.
...
Und `height`: used to specify the dimensions of an **img** or **video** element.
...
Keyboard accessibility is important for users who cannot use a mouse, such as those with motor disabilities. Example:
